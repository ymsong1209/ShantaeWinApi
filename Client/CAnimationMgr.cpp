...
//void CAnimationMgr::CreatePlayerAnim()
//{
//	// Image ·Îµù
//
//	CTexture* pShantaeTex = CResMgr::GetInst()->LoadTexture(L"Shantae", L"texture\\player\\Shantae_original.bmp");
//	CTexture* pShantaeTex_R = CResMgr::GetInst()->LoadTexture(L"Shantae_R", L"texture\\player\\Shantae_original_R.bmp");
//
//
//	GetAnimator()->CreateAnimation(L"Standing_Idle", pShantaeTex, Vec2(6.f, 30.f), Vec2(144.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 7, 1, 7, 0.1f);
//	GetAnimator()->FindAnimation(L"Standing_Idle")->Save(L"animation\\player\\Standing_Idle.anim");
//	GetAnimator()->CreateAnimation(L"Standing_Idle_R", pShantaeTex_R, Vec2(6.f, 30.f), Vec2(144.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 7, 1, 7, 0.1f);
//	GetAnimator()->FindAnimation(L"Standing_Idle_R")->Save(L"animation\\player\\Standing_Idle_R.anim");
//
//	GetAnimator()->CreateAnimation(L"Standing_Idle_Full", pShantaeTex, Vec2(6.f, 207.f), Vec2(180.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 16, 2, 12, 0.1f);
...
//
//	GetAnimator()->CreateAnimation(L"Time_Out_Pants", pShantaeTex, Vec2(6.f, 843.f), Vec2(144.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 17, 2, 12, 0.1f);
//	GetAnimator()->FindAnimation(L"Time_Out_Pants")->Save(L"animation\\player\\Time_Out_Pants.anim");
//
//	GetAnimator()->CreateAnimation(L"Time_Out_Top", pShantaeTex, Vec2(6.f, 1167.f), Vec2(144.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 13, 1, 13, 0.1f);
//	GetAnimator()->FindAnimation(L"Time_Out_Top")->Save(L"animation\\player\\Time_Out_Top.anim");
//
//	GetAnimator()->CreateAnimation(L"Time_Out_Vest", pShantaeTex, Vec2(6.f, 1344.f), Vec2(144.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 13, 1, 13, 0.1f);
//	GetAnimator()->FindAnimation(L"Time_Out_Vest")->Save(L"animation\\player\\Time_Out_Vest.anim");
//
//	GetAnimator()->CreateAnimation(L"Depressed_Idle", pShantaeTex, Vec2(6.f, 1521.f), Vec2(126.f, 144.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 12, 1, 12, 0.1f);
//	GetAnimator()->FindAnimation(L"Depressed_Idle")->Save(L"animation\\player\\Depressed_Idle.anim");
//
//	GetAnimator()->CreateAnimation(L"Exp_Angry", pShantaeTex, Vec2(6.f, 1701.f), Vec2(144.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 8, 1, 8, 0.1f);
//	GetAnimator()->FindAnimation(L"Exp_Angry")->Save(L"animation\\player\\Exp_Angry.anim");
//
//	GetAnimator()->CreateAnimation(L"Exp_Cheer", pShantaeTex, Vec2(6.f, 1878.f), Vec2(162.f, 153.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 8, 1, 8, 0.1f);
//	GetAnimator()->FindAnimation(L"Exp_Cheer")->Save(L"animation\\player\\Exp_Cheer.anim");
//
//	GetAnimator()->CreateAnimation(L"Exp_Shocked", pShantaeTex, Vec2(6.f, 2067.f), Vec2(144.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 2, 1, 2, 0.1f);
//	GetAnimator()->FindAnimation(L"Exp_Shocked")->Save(L"animation\\player\\Exp_Shocked.anim");
//
//	GetAnimator()->CreateAnimation(L"Walk", pShantaeTex, Vec2(6.f, 2244.f), Vec2(162.f, 153.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 18, 2, 12, 0.05f);
//	GetAnimator()->FindAnimation(L"Walk")->Save(L"animation\\player\\Walk.anim");
//
//	GetAnimator()->CreateAnimation(L"Walk_Stop", pShantaeTex, Vec2(6.f, 2592.f), Vec2(180.f, 153.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 10, 1, 10, 0.08f);
//	GetAnimator()->FindAnimation(L"Walk_Stop")->Save(L"animation\\player\\Walk_Stop.anim");
//
//	GetAnimator()->CreateAnimation(L"Run", pShantaeTex, Vec2(6.f, 2781.f), Vec2(234.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 16, 2, 12, 0.025f);
//	GetAnimator()->FindAnimation(L"Run")->Save(L"animation\\player\\Run.anim");
//
//	GetAnimator()->CreateAnimation(L"Run_Stop", pShantaeTex, Vec2(6.f, 3105.f), Vec2(234.f, 153.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 11, 1, 11, 0.08f);
//	GetAnimator()->FindAnimation(L"Run_Stop")->Save(L"animation\\player\\Run_Stop.anim");
//
//	GetAnimator()->CreateAnimation(L"Run_Boost", pShantaeTex, Vec2(6.f, 3294.f), Vec2(270.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 5, 1, 5, 0.1f);
...
//
//	GetAnimator()->CreateAnimation(L"Jump", pShantaeTex, Vec2(6.f, 3636.f), Vec2(126.f, 153.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 4, 1, 4, 0.1f);
//	GetAnimator()->FindAnimation(L"Jump")->Save(L"animation\\player\\Jump.anim");
//
//	GetAnimator()->CreateAnimation(L"Jump_Tuck", pShantaeTex, Vec2(6.f, 3825.f), Vec2(126.f, 153.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 4, 1, 4, 0.1f);
//	GetAnimator()->FindAnimation(L"Jump_Tuck")->Save(L"animation\\player\\Jump_Tuck.anim");
//
//	GetAnimator()->CreateAnimation(L"Fall", pShantaeTex, Vec2(6.f, 4014.f), Vec2(144.f, 201.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 4, 1, 4, 0.1f);
//	GetAnimator()->FindAnimation(L"Fall")->Save(L"animation\\player\\Fall.anim");
//
//	GetAnimator()->CreateAnimation(L"Land", pShantaeTex, Vec2(6.f, 4251.f), Vec2(180.f, 165.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 6, 1, 6, 0.1f);
//	GetAnimator()->FindAnimation(L"Land")->Save(L"animation\\player\\Land.anim");
//
//	GetAnimator()->CreateAnimation(L"Duck", pShantaeTex, Vec2(6.f, 4452.f), Vec2(144.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 7, 1, 7, 0.1f);
//	GetAnimator()->FindAnimation(L"Duck")->Save(L"animation\\player\\Duck.anim");
//
//	GetAnimator()->CreateAnimation(L"Duck_Idle", pShantaeTex, Vec2(6.f, 4629.f), Vec2(126.f, 93.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 10, 1, 10, 0.1f);
//	GetAnimator()->FindAnimation(L"Duck_Idle")->Save(L"animation\\player\\Duck_Idle.anim");
//
//	GetAnimator()->CreateAnimation(L"Duck_Get_Hit", pShantaeTex, Vec2(6.f, 4758.f), Vec2(180.f, 105.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 13, 1, 13, 0.1f);
//	GetAnimator()->FindAnimation(L"Duck_Get_Hit")->Save(L"animation\\player\\Duck_Get_Hit.anim");
//
//	GetAnimator()->CreateAnimation(L"Duck_Get_Hit2", pShantaeTex, Vec2(6.f, 4899.f), Vec2(126.f, 105.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 7, 1, 7, 0.1f);
//	GetAnimator()->FindAnimation(L"Duck_Get_Hit2")->Save(L"animation\\player\\Duck_Get_Hit2.anim");
//
//	GetAnimator()->CreateAnimation(L"Duck_Whip", pShantaeTex, Vec2(6.f, 5040.f), Vec2(324.f, 105.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 8, 1, 8, 0.1f);
//	GetAnimator()->FindAnimation(L"Duck_Whip")->Save(L"animation\\player\\Duck_Whip.anim");
//
//	GetAnimator()->CreateAnimation(L"Crawl", pShantaeTex, Vec2(6.f, 5181.f), Vec2(162.f, 93.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 10, 1, 10, 0.1f);
//	GetAnimator()->FindAnimation(L"Crawl")->Save(L"animation\\player\\Crawl.anim");
//
//	GetAnimator()->CreateAnimation(L"Getup", pShantaeTex, Vec2(6.f, 5310.f), Vec2(144.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 8, 1, 8, 0.1f);
//	GetAnimator()->FindAnimation(L"Getup")->Save(L"animation\\player\\Getup.anim");
//
//	GetAnimator()->CreateAnimation(L"Standing_Whip", pShantaeTex, Vec2(6.f, 5487.f), Vec2(342.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 8, 1, 8, 0.1f);
//	GetAnimator()->FindAnimation(L"Standing_Whip")->Save(L"animation\\player\\Standing_Whip.anim");
//
//	GetAnimator()->CreateAnimation(L"Standing_Whip_Long", pShantaeTex, Vec2(6.f, 5664.f), Vec2(402.f, 141.f), Vec2(0.f, 0.f), Vec2(0.f, 0.f), 12, 1, 12, 0.04f);
//	GetAnimator()->FindAnimation(L"Standing_Whip_Long")->Save(L"animation\\player\\Standing_Whip_Long.anim");
//
//	GetAnimator()->CreateAnimation(L"Jump_Whip", pShantaeTex, Vec2(6.f, 5841.f), Vec2(342.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 8, 1, 8, 0.1f);
//	GetAnimator()->FindAnimation(L"Jump_Whip")->Save(L"animation\\player\\Jump_Whip.anim");
//
//	GetAnimator()->CreateAnimation(L"Enter", pShantaeTex, Vec2(6.f, 6018.f), Vec2(144.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 39, 4, 12, 0.1f);
//	GetAnimator()->FindAnimation(L"Enter")->Save(L"animation\\player\\Enter.anim");
//
//	GetAnimator()->CreateAnimation(L"Exit", pShantaeTex, Vec2(6.f, 6636.f), Vec2(144.f, 153.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 24, 2, 12, 0.1f);
//	GetAnimator()->FindAnimation(L"Exit")->Save(L"animation\\player\\Exit.anim");
//
//	GetAnimator()->CreateAnimation(L"Eat", pShantaeTex, Vec2(6.f, 6984.f), Vec2(180.f, 144.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 21, 2, 12, 0.075f);
...
//
//	GetAnimator()->CreateAnimation(L"Twirl_Loop", pShantaeTex, Vec2(6.f, 7980.f), Vec2(144.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 16, 2, 12, 0.05f);
//	GetAnimator()->FindAnimation(L"Twirl_Loop")->Save(L"animation\\player\\Twirl_Loop.anim");
//
//	GetAnimator()->CreateAnimation(L"Rope_Idle", pShantaeTex, Vec2(6.f, 8304.f), Vec2(90.f, 129.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 4, 1, 4, 0.1f);
...
//
//	GetAnimator()->CreateAnimation(L"Down_Thrust", pShantaeTex, Vec2(6.f, 10233.f), Vec2(144.f, 222.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 3, 1, 3, 0.08f);
...
//
//	GetAnimator()->CreateAnimation(L"Hat_Glide", pShantaeTex, Vec2(6.f, 11013.f), Vec2(234.f, 237.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 8, 1, 8, 0.1f);
...
//
//	GetAnimator()->CreateAnimation(L"Pistol_Pullout", pShantaeTex, Vec2(6.f, 12501.f), Vec2(234.f, 129.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 5, 1, 5, 0.06f);
//	GetAnimator()->FindAnimation(L"Pistol_Pullout")->Save(L"animation\\player\\Pistol_Pullout.anim");
//
//	GetAnimator()->CreateAnimation(L"Pistol_Blast", pShantaeTex, Vec2(6.f, 12666.f), Vec2(216.f, 153.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 6, 1, 6, 0.07f);
//	GetAnimator()->FindAnimation(L"Pistol_Blast")->Save(L"animation\\player\\Pistol_Blast.anim");
//
//	GetAnimator()->CreateAnimation(L"Pistol_Blast_Jump", pShantaeTex, Vec2(6.f, 12855.f), Vec2(234.f, 153.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 6, 1, 6, 0.07f);
...
//
//	GetAnimator()->CreateAnimation(L"Lamp_Dance", pShantaeTex, Vec2(6.f, 13611.f), Vec2(180.f, 165.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 16, 2, 12, 0.075f);
...
//
//	GetAnimator()->CreateAnimation(L"Hurt", pShantaeTex, Vec2(6.f, 14184.f), Vec2(144.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 9, 1, 9, 0.075f);
//	GetAnimator()->FindAnimation(L"Hurt")->Save(L"animation\\player\\Hurt.anim");
//
//	GetAnimator()->CreateAnimation(L"Standing_Get_Hit", pShantaeTex, Vec2(6.f, 14361.f), Vec2(162.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 13, 1, 13, 0.075f);
//	GetAnimator()->FindAnimation(L"Standing_Get_Hit")->Save(L"animation\\player\\Standing_Get_Hit.anim");
//
//	GetAnimator()->CreateAnimation(L"Standup", pShantaeTex, Vec2(6.f, 14538.f), Vec2(144.f, 141.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 3, 1, 3, 0.075f);
//	GetAnimator()->FindAnimation(L"Standup")->Save(L"animation\\player\\Standup.anim");
//
//	GetAnimator()->CreateAnimation(L"Knockdown", pShantaeTex, Vec2(6.f, 14715.f), Vec2(252.f, 153.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 25, 2, 13, 0.075f);
//	GetAnimator()->FindAnimation(L"Knockdown")->Save(L"animation\\player\\Knockdown.anim");
//
//	GetAnimator()->CreateAnimation(L"Die", pShantaeTex, Vec2(6.f, 15498.f), Vec2(180.f, 129.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 11, 1, 11, 0.1f);
//	GetAnimator()->FindAnimation(L"Die")->Save(L"animation\\player\\Die.anim");
//
//	GetAnimator()->CreateAnimation(L"Wakeup", pShantaeTex, Vec2(6.f, 15663.f), Vec2(180.f, 129.f), Vec2(0.f, 0.f), Vec2(6.f, 6.f), 10, 1, 10, 0.1f);
